...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--pkcs',
                        action='store_true', help="use PKCS#7 padding instead of adding 0x1a")
    ...
    if args.transmit:
        ...
        packets = add_padding(filedata, args.pkcs)
        ...
        filedata = remove_padding(filedata, args.pkcs)
